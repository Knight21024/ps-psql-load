...
$i=100;  # you have got to start somewhere
DO {
    $i=$i+1;
    Write-output "PSQL INSERT INTO t1 VALUES ($i, 'Movie $i');"
    & "$psql" --dbname="postgresql://postgres:Password@localhost:5432/postgres" --command "INSERT INTO t1 VALUES ($i, 'Movie $i');"
